...
var Cuenta = /** @class */ (function () {
    ...
    Cuenta.prototype.depositar = function (cantidadParam) {
        if (cantidadParam < 5.00) {
            ...
            this.cantidad += cantidadParam;
            console.log("\nEl dinero se a depositado correctamente \n - Cantidad ingresada: $".concat(cantidadParam));
        }
    };
    Cuenta.prototype.retirar = function (valor) {
        if (this.cantidad <= 5) {
            ...
            this.cantidad -= valor;
            console.log("\nRetiro Exitoso\n - Se ha retirado: $".concat(valor, ". \n - Saldo restante: $").concat(this.cantidad));
        }
    };
    Cuenta.prototype.mostrarDatos = function () {
        console.log("Nombre del tirular: ".concat(this.nombre));
        console.log("Tipo de cuenta: ".concat(this.tipoCuenta));
        console.log("Numero de cuenta: ".concat(this.numeroCuenta));
    };
    return Cuenta;
}());
var cuenta = new Cuenta("Elias Oliva", 250.00, "Cuenta de ahorro", "00-97654-123");
// Para depositar
console.log('\n-- Depositos --');
